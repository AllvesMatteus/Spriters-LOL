...
export default function App() {
  ...
  const detectedLane = baseUserStats.lane || "BOTTOM";
  ...
  return (
    <div className="min-h-screen text-[#e1e1e1] font-sans selection:bg-[#4C92FC]/30 flex flex-col relative overflow-x-hidden">
