          ...
          <div className="w-[72px] h-[72px] rounded-full flex items-center justify-center shrink-0 relative">
            ...
            {data ? (
              <img
                ...
                alt="Rank Atual"
                className="w-full h-full object-contain drop-shadow-2xl scale-[3.2] relative z-10"
            ...
            <div className="flex flex-col flex-1 justify-center relative w-full gap-0.5 group/perf min-w-0">
              <div className="flex items-center gap-1">
                ...
                <div className="relative inline-block cursor-help shrink-0">
                  ...
                  <div className="absolute left-1/2 -translate-x-1/2 bottom-[130%] bg-[#1c1d21]/95 text-[#9e9eb1] text-[10px] leading-relaxed p-2.5 rounded-lg border border-white/10 shadow-2xl opacity-0 pointer-events-none group-hover/perf:opacity-100 transition-opacity duration-300 w-56 z-[100] backdrop-blur-md">
